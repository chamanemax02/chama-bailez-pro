...
export const DEFAULT_CACHE_TTLS = {
    SIGNAL_STORE: 2 * 60, // 2 minutes (was 5 mins)
    MSG_RETRY: 5 * 60, // 5 minutes (was 1 hour)
    CALL_OFFER: 2 * 60, // 2 minutes
    USER_DEVICES: 3 * 60 // 3 minutes
};
export const DEFAULT_CONNECTION_CONFIG = {
    ...
    syncFullHistory: false, // Low RAM optimization: disable full history sync
    patchMessageBeforeSending: msg => msg,
    shouldSyncHistoryMessage: ({ syncType }) => {
        // Low RAM optimization: only sync initial bootstrap for LID mapping, skip chat dumps
        return syncType === proto.HistorySync.HistorySyncType.INITIAL_BOOTSTRAP;
    },
    ...
    enableRecentMessageCache: false, // Low RAM optimization: avoid storing all recent messages
    options: {},
