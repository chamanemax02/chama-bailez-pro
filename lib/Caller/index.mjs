...
export class VoipClient extends EventEmitter {
    ...
    call = async (phoneNumber, opts = {}) => {
        ...
        const peerDeviceJids = await this.#signaling.discoverPeerDevices(peerLid, targetPnJid);
        const deviceList = peerDeviceJids.length ? peerDeviceJids : [`${toBareJid(peerLid).split('@')[0]}:0@lid`, `${targetPnJid.split('@')[0]}:0@s.whatsapp.net`];
